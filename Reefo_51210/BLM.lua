...
local fastCastValue = 0 -- ex. 0.04 = 4% from gear listed in Precast set

local ninSJMaxMP = 408 -- The Max MP you have when /nin in your idle set
local whmSJMaxMP = 464 -- The Max MP you have when /whm in your idle set
local rdmSJMaxMP = 450 -- The Max MP you have when /rdm in your idle set
